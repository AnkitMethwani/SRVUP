...
class CourseQuerySet(models.query.QuerySet):
    ...
    def featured(self):
        return self.filter(Q(category__slug__iexact='Python'))
...
class Course(models.Model):
    ...
    def get_purchase_url(self):
        return reverse("course-purchase", kwargs={"slug": self.slug})
...
class Lecture(models.Model):
    ...
    def get_absolute_url(self):
        ...
        # return reverse("course-detail", kwargs={"slug": self.course.slug})
